...
NotifGroup:AddButton("Top Left", function()
	Library.NotifySide = "LeftUp"
	Library:Notify("Notification: Top Left")
end)
NotifGroup:AddButton("Top Middle", function()
	Library.NotifySide = "MiddleUp"
	Library:Notify("Notification: Top Middle")
end)
NotifGroup:AddButton("Top Right", function()
	Library.NotifySide = "RightUp"
	Library:Notify("Notification: Top Right")
end)
NotifGroup:AddButton("Middle Left", function()
	Library.NotifySide = "Left"
	Library:Notify("Notification: Middle Left")
end)
NotifGroup:AddButton("Middle Center", function()
	Library.NotifySide = "Middle"
	Library:Notify("Notification: Middle Center")
end)
NotifGroup:AddButton("Middle Right", function()
	Library.NotifySide = "Right"
	Library:Notify("Notification: Middle Right")
end)
NotifGroup:AddButton("Bottom Left", function()
	Library.NotifySide = "LeftDown"
	Library:Notify("Notification: Bottom Left")
end)
NotifGroup:AddButton("Bottom Middle", function()
	Library.NotifySide = "MiddleDown"
	Library:Notify("Notification: Bottom Middle")
end)
NotifGroup:AddButton("Bottom Right", function()
	Library.NotifySide = "RightDown"
	Library:Notify("Notification: Bottom Right")
end)
