...
do
    local function CreateNotifArea(anchor, pos, hAlign, vAlign)
    ...
    local HL, HR, HC = Enum.HorizontalAlignment.Left, Enum.HorizontalAlignment.Right, Enum.HorizontalAlignment.Center
    local VT, VB = Enum.VerticalAlignment.Top, Enum.VerticalAlignment.Bottom
    Library.NotifyAreas = {
        leftup     = CreateNotifArea(Vector2.new(0,   0),   UDim2.new(0,   0, 0,    40), HL, VT),
        rightup    = CreateNotifArea(Vector2.new(1,   0),   UDim2.new(1,   0, 0,    40), HR, VT),
        middleup   = CreateNotifArea(Vector2.new(0.5, 0),   UDim2.new(0.5, 0, 0,    40), HC, VT),
        left       = CreateNotifArea(Vector2.new(0,   0.5), UDim2.new(0,   0, 0.5,   0), HL, VT),
        right      = CreateNotifArea(Vector2.new(1,   0.5), UDim2.new(1,   0, 0.5,   0), HR, VT),
        middle     = CreateNotifArea(Vector2.new(0.5, 0.5), UDim2.new(0.5, 0, 0.5,   0), HC, VT),
        leftdown   = CreateNotifArea(Vector2.new(0,   1),   UDim2.new(0,   0, 1,    -5), HL, VB),
        rightdown  = CreateNotifArea(Vector2.new(1,   1),   UDim2.new(1,   0, 1,    -5), HR, VB),
        middledown = CreateNotifArea(Vector2.new(0.5, 1),   UDim2.new(0.5, 0, 1,    -5), HC, VB),
    }
    Library.LeftNotificationArea  = Library.NotifyAreas.leftup
    Library.RightNotificationArea = Library.NotifyAreas.rightup
    ...
    function Library:Notify(...)
        ...
        local isRightSide = (Side == "right" or Side == "rightup" or Side == "rightdown")
        ...
        local NotifyOuter = Library:Create("Frame", {
            ...
            Visible = false;
            Name = "Notif";
            Parent = Library.NotifyAreas[Side] or Library.NotifyAreas.leftup;
        })
        ...
        local ExtraWidth = 0
        local TextPosition = isRightSide and UDim2.new(1, -4, 0, 0) or UDim2.new(0, 4, 0, 0)
        ...
        if Data.Icon then
            ...
            if ParsedIcon then
                ...
                IconLabel = Library:Create("ImageLabel", {
                    BackgroundTransparency = 1,
                    AnchorPoint = Vector2.new(0, 0.5),
                    Position = if not isRightSide then UDim2.new(0, 6, 0.5, 0) else UDim2.new(0, 4, 0.5, 0),
        ...
        local NotifyLabel = Library:CreateLabel({
            AnchorPoint = isRightSide and Vector2.new(1, 0) or Vector2.new(0, 0);
            Position = TextPosition;
            Size = UDim2.new(1, TextSizeOffsetX, 1, TextSizeOffsetY);
            Text = (Data.Title == "" and "" or "[" .. Data.Title .. "] ") .. tostring(Data.Description);
            TextXAlignment = isRightSide and Enum.TextXAlignment.Right or Enum.TextXAlignment.Left;
            TextSize = 14;
            ZIndex = 11003;
            RichText = true;
            Parent = InnerFrame;
        ...
        local SideColor = Library:Create("Frame", {
            AnchorPoint = isRightSide and Vector2.new(1, 0) or Vector2.new(0, 0);
            Position = isRightSide and UDim2.new(1, -1, 0, -1) or UDim2.new(0, -1, 0, -1);
            BackgroundColor3 = Library.AccentColor;
            BorderSizePixel = 0;
